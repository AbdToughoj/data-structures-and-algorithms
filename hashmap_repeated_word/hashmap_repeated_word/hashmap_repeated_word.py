...
def hashmapRepeatedWord(paragraph):
  '''
  args : paragraph
...
if __name__ == '__main__':
    print(hashmapRepeatedWord("It was a queer, sultry summer, the summer they electrocuted the Rosenbergs, and I didn’t know what I was doing in New York..."			))